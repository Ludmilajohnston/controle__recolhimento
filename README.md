...
Data do recolhimento: formato DD-MM-AAAA
Motorista, Conferente e Coord.: campo de texto
...
TecnologiaDescriçãoHTML5Estrutura do sistemaCSS3Estilização responsivaJavaScriptLógica e funcionalidadeshtml2pdf.jsGeração de PDFPWAProgressive Web AppService WorkerFuncionamento offlinelocalStorageSalvamento de dados

📦 Instalação
1. Clone o repositório
bashgit clone https://github.com/Ludmilajohnston/controle_recolhimento.git